...
const base_url =  'http://127.0.0.1:8000/' //window.SERVER_ADDRESS
...
class RegisterUser extends Component {
    ...
    render() {
        return (
            <div>
                <form onSubmit={this.sendRegistration} noValidate className="form-signin">
                    <div>
                        <label htmlFor="first_name" className="sr-only"> First name </label>
                        <input type="text" id="first_name" placeholder="First name" className="form-control" name="first_name" value={this.state.first_name} onChange={this.changeHandler}  />
                        {this.getErrors('first_name', this.state.first_name)}
                    </div>
                    <div>
                        <label htmlFor="last_name" className="sr-only"> Last name </label>
                        <input type="text" id="last_name" placeholder="Last name" className="form-control" name="last_name" value={this.state.last_name} onChange={this.changeHandler}  />
                        {this.getErrors('last_name', this.state.last_name)}
                    </div>
                    <div>
                        <label htmlFor="username" className="sr-only"> Username </label>
                        <input type="text" id="username" placeholder="Username" className="form-control" name="username" value={this.state.username} onChange={this.changeHandler}  />
                        {this.getErrors('username', this.state.username)}
                    </div>
                    <div>
                        <label htmlFor="pass" className="sr-only"> Password </label>
                        <input type="password" id="pass" placeholder="Enter new Password" className="form-control" name="password" value={this.state.password} onChange={this.changeHandler}  />
                        {this.getErrors('password', this.state.password)}
                    </div>
                    <div>
                        <label htmlFor="pass2" className="sr-only"> Password again </label>
                        <input type="password" id="pass2" placeholder="Enter Password again" className="form-control" name="password2" value={this.state.password2} onChange={this.changeHandler}  />
